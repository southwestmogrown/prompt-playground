            ...
            <div className="px-4 pt-3 max-h-[280px] overflow-y-auto">
              ...
              <div className="space-y-0.5">
                {filtered.map((persona) => (
                  <div
                    key={persona.id}
                    className="rounded-xl px-3 py-2 cursor-pointer transition-colors hover:bg-surface-container-low border border-transparent hover:border-primary/10"
                  ...
                  >
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="text-[10px] text-outline shrink-0">{persona.category}</span>
                    </div>
