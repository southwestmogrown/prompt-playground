      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8 space-y-3">
          ...
          <div>
            ...
            <h1 className="font-headline font-extrabold text-2xl tracking-tighter text-on-surface">Create your account</h1>
            <p className="text-on-surface-variant text-sm mt-1">Free to start. Bring your own API keys.</p>
          </div>
        </div>
        ...
        <div className="console-panel rounded-xl overflow-hidden">
          <div className="px-5 py-3 border-b border-[rgba(255,255,255,0.07)] flex items-center gap-2">
            ...
            <span className="console-label">New Account</span>
          </div>
          <div className="p-6">
            <SignupForm />
          </div>
