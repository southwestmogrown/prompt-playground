...
export default async function SignupPage() {
  ...
  return (
    <main className="min-h-screen bg-mesh flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute -bottom-20 -left-40 w-[400px] h-[400px] rounded-full bg-secondary/8 blur-[100px] pointer-events-none" />
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8 space-y-2">
          ...
          <h1 className="font-headline font-extrabold text-3xl tracking-tighter text-on-surface">Create your account</h1>
          <p className="text-on-surface-variant text-sm">Free to start. Bring your own API keys.</p>
        </div>
        <SignupForm />
      </div>
    </main>
